package com.szhua.pagedemo.widget.pinnedsectionitemdecoration;
...
import com.szhua.pagedemo.widget.pinnedsectionitemdecoration.callback.OnHeaderClickListener;
import com.szhua.pagedemo.widget.pinnedsectionitemdecoration.callback.OnItemTouchListener;
import com.szhua.pagedemo.widget.pinnedsectionitemdecoration.utils.DividerHelper;
...
//            final View belowView = parent.findChildViewUnder(c.getWidth() / 2, headEnd + 1);
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mDisableDrawHeader && mPinnedHeaderView != null && mFirstVisiblePosition >= mPinnedHeaderPosition) {
            ...
            textView.setText("sdfsdfdsfd");
            textView.setTextColor(Color.WHITE);
            textView.layout(0,10,300,200);
            textView.draw(c);

            textView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(v.getContext(),"fdsfsd",Toast.LENGTH_LONG).show();
                }
            });
    ...
    private void createPinnedHeader(final RecyclerView parent) {
        ...
        Log.e("leilei",String.valueOf(mFirstVisiblePosition));

        // 获取标签的位置，
        int pinnedHeaderPosition = findPinnedHeaderPosition(mFirstVisiblePosition);

        Log.e("leilei",String.valueOf(pinnedHeaderPosition));
